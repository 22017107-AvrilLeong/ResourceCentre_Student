...
public class ResourceCentreTest {
	...
	public void testAddChromebook() {
		...
		assertEquals("Test that the Chromebook arraylist size is now 1.", 1, chromebookList.size());
	...
	public void testRetrieveAllChromebook() {
		...
		assertEquals("Test that the Chromebook arraylist is empty.", 0, camcorderList.size());
